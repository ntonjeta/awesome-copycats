...
globalkeys = mytable.join(
	...
	awful.key({ altkey, "Control" }, "l", function()
		os.execute(start_scrlocker)
	end, { description = "lock screen", group = "hotkeys" }),
	awful.key({ altkey, "Control" }, "k", function()
		os.execute(stop_scrlocker)
	end, { description = "lock screen", group = "hotkeys" }),

	-- Change Keyboard Layout
	awful.key({ "Shift", "Control" }, "i", function()
		os.execute("setxkbmap it")
	end, { description = "Set keyboard it layout", group = "launcher" }),
	awful.key({ "Shift", "Control" }, "u", function()
		os.execute("setxkbmap us")
	end, { description = "Set keyboard us layout", group = "launcher" }),
	...
	awful.key({ modkey }, "d", function()
		awful.spawn(notes_editor)
	end, { description = "run notes editor", group = "launcher" }),
	awful.key({ modkey }, "e", function()
		awful.spawn(email)
	end, { description = "run email", group = "launcher" }),
